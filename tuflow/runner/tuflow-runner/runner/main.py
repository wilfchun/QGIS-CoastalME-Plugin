...
from plugins.tuflow_plugin import TuflowPlugin
from plugins.tuflowfv_plugin import TuflowFvPlugin
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("TUFLOW Runner")
        ...
        self.tbl_run_queue.verticalHeader().setSectionResizeMode(QT_HEADER_VIEW_RESIZE_TO_CONTENT)
    ...
    def create_menu(self):
        ...
        action_settings.setStatusTip("TUFLOW Runner Settings")
    ...
    def run_ready_models(self):
        if self.tog_run.isChecked():
            ...
            self.run_queue_model.run_ready_models(gpus)
...
if __name__ == "__main__":
    myappid = f'tuflow.modelrunner.{version_text}'  # arbitrary string
    ...
    app.setApplicationName("TUFLOW Runner")
