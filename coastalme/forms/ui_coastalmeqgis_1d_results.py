...
class Ui_coastalmeqgis_1d_results(object):
    def setupUi(self, coastalmeqgis_1d_results):
        coastalmeqgis_1d_results.setObjectName(_fromUcme8("coastalmeqgis_1d_results"))
        ...
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("accepted()")), coastalmeqgis_1d_results.accept)
        self.buttonBox.accepted.connect(coastalmeqgis_1d_results.acceptt)
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("rejected()")), coastalmeqgis_1d_results.reject)
