...
class Ui_coastalmeqgis_menu(object):
    def setupUi(self, coastalmeqgis_menu):
        coastalmeqgis_menu.setObjectName(_fromUcme8("coastalmeqgis_menu"))
        ...
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("accepted()")), coastalmeqgis_menu.accept)
        self.buttonBox.accepted.connect(coastalmeqgis_menu.accept)
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("rejected()")), coastalmeqgis_menu.reject)
