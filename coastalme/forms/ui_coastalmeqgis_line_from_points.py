...
class Ui_coastalmeqgis_line_from_point(object):
    def setupUi(self, coastalmeqgis_line_from_point):
        coastalmeqgis_line_from_point.setObjectName(_fromUcme8("coastalmeqgis_line_from_point"))
        ...
        self.outfilename.setObjectName(_fromUcme8("outfilename"))
        ...
        self.dmax.setObjectName(_fromUcme8("dmax"))
        ...
        self.elev_attr.setObjectName(_fromUcme8("elev_attr"))
