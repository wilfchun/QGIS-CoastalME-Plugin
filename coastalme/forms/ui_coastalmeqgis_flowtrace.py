...
#
# Created: Cmee Jan 19 11:20:12 2016
...
class Ui_coastalmeqgis_flowtrace(object):
    def setupUi(self, coastalmeqgis_flowtrace):
        coastalmeqgis_flowtrace.setObjectName(_fromUcme8("coastalmeqgis_flowtrace"))
