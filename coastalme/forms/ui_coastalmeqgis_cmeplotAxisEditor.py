...
# Form implementation generated from reading ui file 'ui_coastalmeqgis_cmeplotAxisEditor.ui'
#
...
class Ui_cmeplotAxisEditor(object):
    def setupUi(self, cmeplotAxisEditor):
        cmeplotAxisEditor.setObjectName(_fromUcme8("cmeplotAxisEditor"))
        cmeplotAxisEditor.resize(291, 196)
        self.buttonBox = QDialogButtonBox(cmeplotAxisEditor)
        ...
        self.xAxisCustom_rb.setObjectName(_fromUcme8("xAxisCustom_rb"))
        self.buttonGroup = QButtonGroup(cmeplotAxisEditor)
        self.buttonGroup.setObjectName(_fromUcme8("buttonGroup"))
        ...
        self.xMin_sb.setObjectName(_fromUcme8("xMin_sb"))
        ...
        self.yAxisAuto_rb.setObjectName(_fromUcme8("yAxisAuto_rb"))
        self.buttonGroup_2 = QButtonGroup(cmeplotAxisEditor)
        self.buttonGroup_2.setObjectName(_fromUcme8("buttonGroup_2"))
        ...
        self.xInc_sb.setObjectName(_fromUcme8("xInc_sb"))
        ...
        self.xMax_sb.setObjectName(_fromUcme8("xMax_sb"))
        ...
        self.yInc_sb.setObjectName(_fromUcme8("yInc_sb"))
        ...
        self.xAxisAuto_rb.setObjectName(_fromUcme8("xAxisAuto_rb"))
        ...
        self.yMin_sb.setObjectName(_fromUcme8("yMin_sb"))
        ...
        self.yMax_sb.setObjectName(_fromUcme8("yMax_sb"))
        ...
        self.yAxisCustom_rb.setObjectName(_fromUcme8("yAxisCustom_rb"))
        self.buttonGroup_2.addButton(self.yAxisCustom_rb)
        self.tabWidget.addTab(self.tab, _fromUcme8(""))
        self.tab_2 = QWidget()
        self.tab_2.setObjectName(_fromUcme8("tab_2"))
        ...
        self.line_2.setObjectName(_fromUcme8("line_2"))
        self.groupBox = QGroupBox(self.tab_2)
        self.groupBox.setGeometry(QtCore.QRect(150, 0, 141, 141))
        self.groupBox.setTitle(_fromUcme8(""))
        self.groupBox.setObjectName(_fromUcme8("groupBox"))
        self.label_12 = QLabel(self.groupBox)
        self.label_12.setGeometry(QtCore.QRect(75, 110, 61, 16))
        self.label_12.setObjectName(_fromUcme8("label_12"))
        ...
        self.yInc_sb_2.setObjectName(_fromUcme8("yInc_sb_2"))
        self.label_10 = QLabel(self.groupBox)
        self.label_10.setGeometry(QtCore.QRect(75, 48, 61, 16))
        self.label_10.setObjectName(_fromUcme8("label_10"))
        ...
        self.yMin_sb_2.setObjectName(_fromUcme8("yMin_sb_2"))
        self.label_8 = QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(75, 79, 61, 16))
        self.label_8.setObjectName(_fromUcme8("label_8"))
        ...
        self.yAxisAuto_rb_2.setObjectName(_fromUcme8("yAxisAuto_rb_2"))
        self.buttonGroup_4 = QButtonGroup(cmeplotAxisEditor)
        self.buttonGroup_4.setObjectName(_fromUcme8("buttonGroup_4"))
        ...
        self.xMin_sb_2.setObjectName(_fromUcme8("xMin_sb_2"))
        ...
        self.xMax_sb_2.setObjectName(_fromUcme8("xMax_sb_2"))
        ...
        self.xAxisAuto_rb_2.setObjectName(_fromUcme8("xAxisAuto_rb_2"))
        self.buttonGroup_3 = QButtonGroup(cmeplotAxisEditor)
        self.buttonGroup_3.setObjectName(_fromUcme8("buttonGroup_3"))
        self.buttonGroup_3.addButton(self.xAxisAuto_rb_2)
        self.label_11 = QLabel(self.groupBox_2)
        self.label_11.setGeometry(QtCore.QRect(86, 49, 61, 16))
        self.label_11.setObjectName(_fromUcme8("label_11"))
        self.label_7 = QLabel(self.groupBox_2)
        self.label_7.setGeometry(QtCore.QRect(86, 78, 61, 16))
        self.label_7.setObjectName(_fromUcme8("label_7"))
        ...
        self.xInc_sb_2.setObjectName(_fromUcme8("xInc_sb_2"))
        self.label_9 = QLabel(self.groupBox_2)
        self.label_9.setGeometry(QtCore.QRect(86, 109, 61, 16))
        self.label_9.setObjectName(_fromUcme8("label_9"))
        self.xAxisCustom_rb_2 = QRadioButton(self.groupBox_2)
        self.xAxisCustom_rb_2.setGeometry(QtCore.QRect(20, 23, 121, 17))
        self.xAxisCustom_rb_2.setObjectName(_fromUcme8("xAxisCustom_rb_2"))
        self.buttonGroup_3.addButton(self.xAxisCustom_rb_2)
        self.tabWidget.addTab(self.tab_2, _fromUcme8(""))

        self.retranslateUi(cmeplotAxisEditor)
        self.tabWidget.setCurrentIndex(0)
        self.buttonBox.accepted.connect(cmeplotAxisEditor.accept)
        self.buttonBox.rejected.connect(cmeplotAxisEditor.reject)
        QtCore.QMetaObject.connectSlotsByName(cmeplotAxisEditor)

    def retranslateUi(self, cmeplotAxisEditor):
        cmeplotAxisEditor.setWindowTitle(_translate("cmeplotAxisEditor", "Cmeplot", None))
        self.xAxisCustom_rb.setText(_translate("cmeplotAxisEditor", "Custom X Axis Limits", None))
        self.label_2.setText(_translate("cmeplotAxisEditor", "X Maximum", None))
        self.yAxisAuto_rb.setText(_translate("cmeplotAxisEditor", "Auto Y Axis", None))
        self.label_3.setText(_translate("cmeplotAxisEditor", "Y Maximum", None))
        self.label_5.setText(_translate("cmeplotAxisEditor", "X Increment", None))
        self.label_4.setText(_translate("cmeplotAxisEditor", "Y Minimum", None))
        self.xAxisAuto_rb.setText(_translate("cmeplotAxisEditor", "Auto X Axis", None))
        self.label.setText(_translate("cmeplotAxisEditor", "X Minimum", None))
        self.label_6.setText(_translate("cmeplotAxisEditor", "Y Increment", None))
        self.yAxisCustom_rb.setText(_translate("cmeplotAxisEditor", "Custom Y Axis Limits", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("cmeplotAxisEditor", "Primary Axis", None))
        self.label_12.setText(_translate("cmeplotAxisEditor", "Y Increment", None))
        self.label_10.setText(_translate("cmeplotAxisEditor", "Y Minimum", None))
        self.label_8.setText(_translate("cmeplotAxisEditor", "Y Maximum", None))
        self.yAxisAuto_rb_2.setText(_translate("cmeplotAxisEditor", "Auto Y Axis", None))
        self.yAxisCustom_rb_2.setText(_translate("cmeplotAxisEditor", "Custom Y Axis Limits", None))
        self.xAxisAuto_rb_2.setText(_translate("cmeplotAxisEditor", "Auto X Axis", None))
        self.label_11.setText(_translate("cmeplotAxisEditor", "X Minimum", None))
        self.label_7.setText(_translate("cmeplotAxisEditor", "X Maximum", None))
        self.label_9.setText(_translate("cmeplotAxisEditor", "X Increment", None))
        self.xAxisCustom_rb_2.setText(_translate("cmeplotAxisEditor", "Custom X Axis Limits", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("cmeplotAxisEditor", "Secondary Axis", None))
