...
class Ui_coastalmeqgis_splitMI(object):
    def setupUi(self, coastalmeqgis_splitMI):
        coastalmeqgis_splitMI.setObjectName(_fromUcme8("coastalmeqgis_splitMI"))
        ...
        self.outfolder.setObjectName(_fromUcme8("outfolder"))
        ...
        self.outprefix.setObjectName(_fromUcme8("outprefix"))
