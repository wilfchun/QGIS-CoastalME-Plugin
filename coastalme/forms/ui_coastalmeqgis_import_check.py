...
class Ui_coastalmeqgis_import_check(object):
    def setupUi(self, coastalmeqgis_import_check):
        coastalmeqgis_import_check.setObjectName(_fromUcme8("coastalmeqgis_import_check"))
        ...
        self.browsedir.setObjectName(_fromUcme8("browsedir"))
        ...
        self.emptydir.setObjectName(_fromUcme8("emptydir"))
        ...
        self.txtRunID.setObjectName(_fromUcme8("txtRunID"))
        ...
        self.showchecks.setObjectName(_fromUcme8("showchecks"))
        ...
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("accepted()")), coastalmeqgis_import_check.accept)
        self.buttonBox.accepted.connect(coastalmeqgis_import_check.accept)
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUcme8("rejected()")), coastalmeqgis_import_check.reject)
