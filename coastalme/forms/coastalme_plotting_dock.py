...
# Form implementation generated from reading ui file 'C:\Users\esymons\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\coastalme\forms\coastalme_plotting_dock.ui'
#
...
class Ui_Cmeplot(object):
    def setupUi(self, Cmeplot):
        Cmeplot.setObjectName("Cmeplot")
        Cmeplot.resize(1067, 619)
        ...
        self.label_4.setPixmap(QtGui.QPixmap(":/logo/resources/COASTALME_logo_resized.png"))
        ...
        self.label_5.setPixmap(QtGui.QPixmap(":/logo/resources/COASTALME_logo_resized.png"))
        ...
        Cmeplot.setWidget(self.dockWidgetContents)

        self.retranslateUi(Cmeplot)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Cmeplot)

    def retranslateUi(self, Cmeplot):
        _translate = QtCore.QCoreApplication.translate
        Cmeplot.setWindowTitle(_translate("Cmeplot", "COASTALME Viewer"))
        self.pbHidePlotWindow.setText(_translate("Cmeplot", "Hide Plot Window >>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.TimeSeriesTab), _translate("Cmeplot", "Time Series"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.LongPlotTab), _translate("Cmeplot", "Cross Section / Long Profile"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.CrossSectionTab), _translate("Cmeplot", "1D Cross Section Viewer"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.VerticalProfileTab), _translate("Cmeplot", "Vertical Profile"))
        self.pbShowPlotWindow.setText(_translate("Cmeplot", "<< Plot Window"))
        self.label.setText(_translate("Cmeplot", "Open Results"))
        self.label_3.setText(_translate("Cmeplot", "Map Output Plotting"))
        self.cboSelectType.setItemText(0, _translate("Cmeplot", "From Map"))
        self.cboSelectType.setItemText(1, _translate("Cmeplot", "From Map Multi"))
        self.cboSelectType.setItemText(2, _translate("Cmeplot", "Layer Selection"))
        self.plotCoords.setText(_translate("Cmeplot", "X:  Y:  Z:"))
        self.cbShowCurrentTime.setText(_translate("Cmeplot", "Show Current Time"))
        self.cbShowAsDates.setText(_translate("Cmeplot", "Show as dates"))
        self.label_6.setText(_translate("Cmeplot", "Result Type"))
        self.OpenResultTypes.setToolTip(_translate("Cmeplot", "Test"))
        self.btnFirst.setToolTip(_translate("Cmeplot", "First Timestep"))
        self.btnFirst.setText(_translate("Cmeplot", "|<"))
        self.btnPrev.setToolTip(_translate("Cmeplot", "Previous Timestep"))
        self.btnPrev.setText(_translate("Cmeplot", "<"))
        self.btnNext.setToolTip(_translate("Cmeplot", "Next Timestep"))
        self.btnNext.setText(_translate("Cmeplot", ">"))
        self.btnLast.setToolTip(_translate("Cmeplot", "Last Timestep"))
        self.btnLast.setText(_translate("Cmeplot", ">|"))
        self.btnTimePlay.setToolTip(_translate("Cmeplot", "Play Through Timesteps"))
        self.btnTimePlay.setText(_translate("Cmeplot", "..."))
        self.btn2dLock.setToolTip(_translate("Cmeplot", "Lock Timesteps to Map Outputs"))
        self.btn2dLock.setText(_translate("Cmeplot", "..."))
