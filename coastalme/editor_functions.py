...
add "from coastalme.editor_functions import editor_swmm_links_conduits"
...
from coastalme.coastalme_swmm.qgis.editor_forms.swmm_links_conduits_editor import swmm_links_conduits_editor
