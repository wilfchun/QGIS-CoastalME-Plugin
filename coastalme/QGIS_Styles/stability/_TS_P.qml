...
<qgis styleCategories="Symbology" version="3.24.2-Tisler">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{b7f545cd-ec45-42eb-a70e-4fd302598c3f}">
      <rule symbol="0" filter=" coastalme_ts_likely_unstable() " key="{9d4eb47d-a178-4d07-afac-4f4bfc599163}" label="Likely Unstable"/>
      <rule symbol="1" filter="coastalme_ts_possibly_unstable() " key="{2839bc89-ccc9-4859-8927-96dbe771b58e}" label="Possibly Unstable"/>
      <rule symbol="2" filter="ELSE" key="{bc7ed4e3-f466-4b2f-bdbf-8f50c5ebd086}" label="Stable"/>
    </rules>
    <symbols>
      ...
      <symbol type="marker" force_rhr="0" alpha="1" clip_to_extent="1" name="1">
        ...
        <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
            <Option type="QString" value="247,128,30,255" name="color"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="circle" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="179,92,21,255" name="outline_color"/>
            <Option type="QString" value="solid" name="outline_style"/>
            <Option type="QString" value="0.4" name="outline_width"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale"/>
            <Option type="QString" value="MM" name="outline_width_unit"/>
