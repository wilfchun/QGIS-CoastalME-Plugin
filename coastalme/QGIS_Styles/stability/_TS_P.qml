...
<qgis styleCategories="Symbology" version="3.24.2-Tisler">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{b7f545cd-ec45-42eb-a70e-4fd302598c3f}">
      <rule symbol="0" filter=" tuflow_ts_likely_unstable() " key="{9d4eb47d-a178-4d07-afac-4f4bfc599163}" label="Likely Unstable"/>
      <rule symbol="1" filter="tuflow_ts_possibly_unstable() " key="{2839bc89-ccc9-4859-8927-96dbe771b58e}" label="Possibly Unstable"/>
