...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" readOnly="0" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="1e+08" simplifyAlgorithm="0" version="3.5.0-Master" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyLocal="1">
  ...
  <aliases>
    <alias index="0" field="NS_ID" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default expression="" field="NS_ID" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="NS_ID"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="NS_ID"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      <column type="field" width="-1" hidden="0" name="NS_ID"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="NS_ID"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="NS_ID"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>NS_ID</previewExpression>
  <mapTip></mapTip>
