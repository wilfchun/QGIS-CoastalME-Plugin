...
class ArrCCF:
    ...
    def write_rainfall_to_file(self, name: str, out_dir: Path) -> None:
        ...
        try:
            with fpath.open('w') as f:
                f.write(f'This file has been generated using ARR_to_COASTALME. The rainfall factors have been calculated for '
        ...
        try:
            with fpath.open('w') as f:
                f.write('This file has been generated using ARR_to_COASTALME. The rainfall depths have been calculated for '
                        f'the scenario "{name}" which uses the following parameters- {scen.param_to_string()}.\n')
                if pdv_major < 2 and pdv_minor <= 4:
    ...
    def write_losses_to_file(self, name: str, out_dir: Path) -> None:
        ...
        try:
            with fpath.open('w') as f:
                f.write('This file has been generated using ARR_to_COASTALME. The losses have been calculated for '
                        f'the scenario "{name}" which uses the following parameters- {scen.param_to_string()}.\n')
                if pdv_major < 2 and pdv_minor <= 4:
