...
from coastalme.ARR2016.ARR_COASTALME_func_lib import *
from coastalme.ARR2016.BOM_WebRes import Bom
from coastalme.ARR2016.meta import ArrMeta
from coastalme.ARR2016.climate_change import ArrCCF
from coastalme.ARR2016.losses import ArrLosses
from coastalme.ARR2016.preburst import ArrPreburst
from coastalme.ARR2016.arr_settings import ArrSettings
from coastalme.ARR2016.parser import DataBlock
...
class Arr:
    ...
    def export(self, fpath, aep, dur, **kwargs):
        ...
        coastalme_loss_method = kwargs['coastalme_loss_method'] if 'coastalme_loss_method' in kwargs else 'infiltration'
        ...
        if self.Arf.loaded and catchment_area > 1.0 or self.Limb.has_limb and not self.Limb.ifd.error:
            if catchment_area > 1.0:
                ...
                try:
                    ...
                    return
                arf_file_open.write(
                    'This file has been generated using ARR_to_COASTALME. Areal Reducation Factors have been calculated '
            ...
            try:
                ...
                return
            fo_arf_depths.write(
                'This file has been generated using ARR_to_COASTALME. Areal Reduction Factors have been applied to '
            ...
            if self.CCF.meta.version > 2024000:
                ...
                for year, k in cc_years_dict.items():
                    ...
                    for rcp in cc_RCP:
                        ...
                        cc_file_open.write(
                            'This file has been generated using ARR_to_COASTALME. Climate Change rainfall '
        ...
        fpb.write('This file has been generated using ARR_to_COASTALME. The PreBurst depths have been generated from '
        ...
        if self.Losses.existsPNLosses and probability_neutral_losses:
            if self.Losses.ils_user is not None:
                flosses.write(
                    'This File has been generated using ARR_to_COASTALME. The Burst losses have been calculated by '
            ...
            if process_aep:  # AEP data exists
                ...
                for d, duration in enumerate(dur_list):
                    ...
                    if process_dur:
                        ...
                        # ts1
                        fo.write('! Written by COASTALME ARR Python Script based on {0} temporal pattern\n'.format
                                 (aep_band))
                        if out_form == 'ts1':
                            line3 = 'Time (min)'
                        else:
...
#
    ...
    #                'Eqn: IL Burst = User IL x IL Burst ARR / IL Storm ARR\n')
    #        else:
    #            flosses.write('This File has been generated using ARR_to_COASTALME. The Burst losses have been calculated by '
    #                          'using Probability Neutral Burst Initial Losses provided by the Datahub.\n')
    #    else:
    #        if self.Losses.ils_user is not None:
    #            flosses.write(
...
#
    ...
    #                            format(neg_entries, perc_neg))
        ...
        if coastalme_loss_method == 'infiltration':
        ...
        try:
            with open(trd, 'w') as trd_open:
                trd_open.write("! COASTALME READ FILE - SET RAINFALL LOSS VARIABLES\n")
...
if __name__ == '__main__':
    file = r"C:\COASTALME\ARR2016\QGIS\Whole_catchment\data\ARR_Web_data_catch_A.txt"
