...
class Connectivity(QObject):
    ...
    def _trace_upstream(self, start_chan, end_chan):
        ...
        self.timeout_limit = float(QSettings().value('coastalme/flow_trace_timeout', 30))
        self.rd = sys.getrecursionlimit()
        sys.setrecursionlimit(int(QSettings().value('coastalme/flow_trace_recursion_limit', 25)))
