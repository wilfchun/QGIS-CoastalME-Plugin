...
from coastalme.forms.flowtrace_plot_widget import Ui_flowTracePlotWidget
import matplotlib.pyplot as plt
from matplotlib.patches import Polygon
from matplotlib.backends.backend_qt5agg import FigureCanvasQTAgg, NavigationToolbar2QT
from coastalme.dataset_menu import DatasetMenu
...
class FlowTracePlot(QWidget, Ui_flowTracePlotWidget):
    ...
    def _zoom_to_paths(self):
        ...
        if self.iface is None:
            QMessageBox.warning(self, 'Long Plot', 'Unexpected error - please contact support@coastalme.com')
            return
