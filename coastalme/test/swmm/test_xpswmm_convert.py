...
from coastalme.coastalme_swmm.xpswmm_xpx_convert import convert_xpswmm
...
class TestXpswmmConvert(unittest.TestCase):
    ...
    def test_all_in_one(self):
        ...
        tcf_filename_in = output_folder / 'COASTALME\\runs\\1D2D_Urban_001.tcf'
        tcf_filename_out = output_folder / 'COASTALME\\runs\\1D2D_Urban_001_~e1~.tcf'
        swmm_prefix = 'urban'
        crs = 'EPSG:32760'

        output_folder_1donly = '' # not used
        default_event_name = 'event1'
        gis_layers_filename = output_folder / 'COASTALME\\model\\gis\\1d2d_urban_gis_layers_001.gpkg'
        ...
        tbc_relative = 'COASTALME\\model\\1D2D_Urban_001.tbc'
