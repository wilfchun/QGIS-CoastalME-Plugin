...
from coastalme.coastalme_swmm.create_swmm_section_gpkg import add_swmm_section_to_gpkg, create_section_from_gdf
from coastalme.coastalme_swmm.swmm_sections import swmm_section_definitions, GeometryType, SectionType
from coastalme.coastalme_swmm.swmm_defaults import default_options_table, default_reporting_table, has_gpd
from coastalme.coastalme_swmm.swmm_gdal import delete_layer_features
...
class GeoPackageCreate(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if not Path(gpkg_file).exists():
            write_coastalme_version(gpkg_file)
