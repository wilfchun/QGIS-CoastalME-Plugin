...
def count_lines(file, write_empty=False):
    from ..convert_coastalme_model_gis_format.conv_tf_gis_format.helpers.empty_files import TuflowEmptyFiles
...
class ConvertTuflowModelGisFormat(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        struct_json = Path(
            __file__).parent.parent / 'convert_coastalme_model_gis_format' / 'conv_tf_gis_format' / 'data' / 'dir_relationships.json'
        with struct_json.open() as fo:
            default_struct = json.load(fo)
        param = ProcessingParameterConvTufModelDirSettings('coastalme_dir_struct_settings',
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        script = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'convert_coastalme_model_gis_format',
                              'conv_tf_gis_format', 'convert_coastalme_gis_format.py')
