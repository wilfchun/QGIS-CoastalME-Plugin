...
# from coastalme_swmm.swmm_to_gis import swmm_to_gpkg
from coastalme.coastalme_swmm.fix_multi_link_oulets import extend_multi_link_outfalls
...
class SwmmFixOutletsMuliLinks(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFile(
                'INPUT',
                self.tr('GeoPackage in COASTALME-SWMM Format'),
                extension='gpkg',
            )
        )
        self.addParameter(
