...
from coastalme.coastalme_swmm import estry_to_swmm_gis_layers as estry_layers_to_swmm
from coastalme.coastalme_swmm import swmm_defaults
from coastalme.coastalme_swmm import create_swmm_section_gpkg as swmm_gpkg
...
class ConvertESTRYLayers(QgsProcessingAlgorithm):
    ...
    def name(self):
        ...
        """
        return 'COASTALMEConvertESTRYLayersToSWMM'
