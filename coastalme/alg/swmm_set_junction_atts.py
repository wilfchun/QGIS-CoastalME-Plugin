...
from coastalme.coastalme_swmm.set_junction_atts import get_junction_atts


class SetJunctionAtts(QgsProcessingFeatureBasedAlgorithm):
    """
    This processing tool assigns nodal attributes for junctions based upon SWMM and COASTALME-SWMM conventions.
    """
