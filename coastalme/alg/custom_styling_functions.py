...
def coastalme_ts_likely_unstable(feature, parent, context):
...
@qgsfunction(args="auto", group='Custom')
def coastalme_ts_possibly_unstable(feature, parent, context):
    time_series = TS_GIS_Feature(feature)
...
class CustomStylingFunctions(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'Custom COASTALME Styling Functions'
    ...
    def shortHelpString(self):
        return self.tr(
            "Ancillary database of custom functions used by the COASTALME plugin for styling."
            "This toolbox does not run any scripts, it only serves as a helper to the COASTALME "
            "plugin."
        )

    def shortDescription(self):
        return self.tr("Ancillary database of custom functions used by the COASTALME plugin for styling."
                       "This toolbox does not run any scripts, it only serves as a helper to the COASTALME "
                       "plugin.")
