...
from coastalme.coastalme_swmm.create_endpoint_connections import create_endpoint_connections
...
class CreateEndpointConnections(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        #source_layer = coastalmeqgis_find_layer(conduits_layer_name, search_type='layerid')
