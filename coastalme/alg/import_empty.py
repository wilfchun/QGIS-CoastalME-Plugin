...
from ..utils import coastalme_plugin, ProjectConfig, empty_types_from_project_folder, empty_tooltip, EmptyCreator
...
class ImportEmpty_CustomDialog(AlgorithmDialog):
    ...
    def browse_folder(self):
        ...
        elif QgsProject.instance().readEntry('coastalme', 'import_empty/import_gpkg_kart_repo', None)[0]:
            start_dir = QgsProject.instance().readEntry('coastalme', 'import_empty/import_gpkg_kart_repo', None)[0]
        elif self.project_folder:
            start_dir = self.project_folder
        else:
            start_dir = QDir.homePath()
...
class ImportEmpty(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config: typing.Dict[str, typing.Any] = ...) -> None:
        ...
        # gpkg export options
        prev_export_option = QgsProject.instance().readNumEntry('coastalme', 'import_empty/import_gpkg_option', 0)[0]
        ...
        prev_gpkg_db = QgsProject.instance().readEntry('coastalme', 'import_empty/import_gpkg_db', None)[0]
        ...
        prev_kart = QgsProject.instance().readEntry('coastalme', 'import_empty/import_gpkg_kart_repo', None)[0]
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        # save settings
        QgsProject.instance().writeEntry('coastalme', 'import_empty/import_gpkg_option', gpkg_export_option)
        QgsProject.instance().writeEntry('coastalme', 'import_empty/import_gpkg_db', gpkg_folder)
        QgsProject.instance().writeEntry('coastalme', 'import_empty/import_gpkg_kart_repo', kart_repo)
    ...
    def icon(self) -> QIcon:
        if coastalme_plugin():
            return coastalme_plugin().icon('import_empty')
        return QIcon()
