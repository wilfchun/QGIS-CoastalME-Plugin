...
class CreateCmeflowCatchProject_CustomDialog(AlgorithmDialog):
    """
    ...
    def event_handler(self):
        ...
        folder = Path(folder)
        settings = folder / 'cmesettings.json'
...
# QGIS_VERSION>=32800
class CreateCmeflowProject(QgsProcessingAlgorithm):
    ...
    def createCustomParametersWidget(self, parent=None):
        ...
        return CreateCmeflowCatchProject_CustomDialog(self, False, parent)
