...
from coastalme.toc.MapLayerParameterHelper import MapLayerParameterHelper
from coastalme.coastalme_swmm.junctions_to_storage import junctions_to_storage
...
from coastalme.compatibility_routines import QT_DOUBLE, QT_STRING, QT_INT
...
class ConvertJunctionsToStorage(QgsProcessingAlgorithm):
    ...
    def name(self):
        ...
        """
        return 'COASTALME_SWMMConvertJunctionsStorage'
