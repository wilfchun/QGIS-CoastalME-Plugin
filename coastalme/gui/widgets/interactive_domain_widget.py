...
from coastalme.gui.interactive_rect_map_tool import InteractiveRectMapTool
from coastalme.compatibility_routines import QT_TOOLBUTTIN_INSTANT_POPUP, QT_WHITE, Path
from coastalme.utils.create_grid_commands import ExtentCalculator
...
class InteractiveDomainWidget(QWidget):
    ...
    def __init__(self, map_canvas, parent=None):
        ...
        self.setWindowTitle('COASTALME Model Domain')
    ...
    def log_info(self, msg):
        self.msg_bar.pushMessage( 'COASTALME Domain', msg, level=LOG_LEVEL_INFO)

    def log_warning(self, msg):
        self.msg_bar.pushMessage('COASTALME Domain', msg, level=LOG_LEVEL_WARNING)

    def log_error(self, msg):
        self.msg_bar.pushMessage('COASTALME Domain', msg, level=LOG_LEVEL_ERROR)
    ...
    def set_color(self, color):
        QgsSettings().setValue('/coastalme/create_domain_color', color.name())
        self.color = color
...
class DomainInputWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_color.setColor(QColor(QgsSettings().value('/coastalme/create_domain_color', '#000')))
