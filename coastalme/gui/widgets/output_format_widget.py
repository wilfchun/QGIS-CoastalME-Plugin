...
from coastalme.compatibility_routines import QT_ABSTRACT_ITEM_VIEW_ALL_EDIT_TRIGGERS, QT_TOOLBUTTIN_INSTANT_POPUP, QT_ITEM_DATA_EDIT_ROLE, Path
from coastalme.bridge_editor.BridgeEditorTable import HeaderChannelTable
from coastalme.gui.widgets.custom_delegates import ComboBoxDelegate, DoubleSpinBoxDelegate, MultiComboBoxDelegate
