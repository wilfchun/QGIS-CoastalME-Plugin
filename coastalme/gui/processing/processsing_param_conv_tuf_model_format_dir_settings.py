...
class ProcessingParameterConvCmefModelDirSettings(QgsProcessingParameterDefinition):

    def __init__(self, name, description, default=None, optional=False):
        super().__init__(name, description, default, optional)
        self.setMetadata({'widget_wrapper': ConvCmefModelDirSettingsWidgetWrapper})
...
class ConvCmefModelDirSettingsWidgetWrapper(WidgetWrapper):
    ...
    def createWidget(self):
        if not self.widget:
            self.widget = ConvCmefModelDirSettingsInputWidget(
...
class ConvCmefModelDirSettingsInputWidget(QWidget):
    ...
    def dirSettingsTooltip(self):
        p = Path(__file__).parent.parent.parent / 'alg' / 'help' / 'html' / 'alg_convert_coastalme_model_gis_format_tuf_dir_settings.html'
    ...
    def showDialog(self):
        ...
        if panel and panel.dockMode():
            self.panel_widget = ConvCmefModelDirSettingsPanel(panel, self.value)
...
class ConvCmefModelDirSettingsPanel(QgsPanelWidget):
