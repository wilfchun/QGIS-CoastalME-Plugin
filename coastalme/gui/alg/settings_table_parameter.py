...
from coastalme.compatibility_routines import Path, QT_FRAME_HLINE, QT_FRAME_SUNKEN
from coastalme.gui.widgets.settings_table import SettingsTable
...
class SettingsTableWidget(QWidget):
    ...
    def showDialog(self):
        ...
        if self.tooltip_widget:
            ...
            p = Path(__file__).parents[2] / 'alg' / 'help' / 'html' / 'coastalme_settings_table.html'
            with p.open() as f:
