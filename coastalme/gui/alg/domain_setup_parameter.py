...
from coastalme.gui.widgets.interactive_domain_widget import InteractiveDomainWidget
...
class DomainSetupWidget(QWidget):
    ...
    def showDialog(self):
        ...
        if self.tooltip_widget:
            ...
            with p.open() as f:
                self.tooltip_widget.setHtml(f.read().replace('${plugin_folder}', pluginDirectory('coastalme')))
