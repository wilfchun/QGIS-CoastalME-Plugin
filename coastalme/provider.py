...
# We need this path setup for the SWMM alg functions to find the coastalme_swmm folder. It is here instead of
...
class CmeflowAlgorithmProvider(QgsProcessingProvider):
    """
    ...
    def icon(self):
        ...
        return QIcon(os.path.join(os.path.dirname(__file__), 'coastalme.png'))
