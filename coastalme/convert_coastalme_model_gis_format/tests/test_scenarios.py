...
TCF = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios.tcf'
...
class TestScenarios(unittest.TestCase):
    ...
    def test_test_scenarios_nested(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios_nested.tcf'
    ...
    def test_test4_scenarios_nested(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios_nested_2.tcf'
    ...
    def test_test5_scenarios_nested(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios_nested_3.tcf'
    ...
    def test_scenarios_in_fname_no_scenarios(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios_in_fname.tcf'
    ...
    def test_event_also_works(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_events.tcf'
    ...
    def test_scenario_2(self):
        tcf = Path(__file__).parent / r'./scenarios/COASTALME/runs/test_scenarios_2.tcf'
