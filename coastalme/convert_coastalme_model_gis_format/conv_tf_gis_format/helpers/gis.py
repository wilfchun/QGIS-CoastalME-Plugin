...
def ogr_format(file, no_ext_is_mif=False, no_ext_is_gpkg=False):
    ...
    raise MinorConvertException(f'Error: Vector format not supported by COASTALME: {TuflowPath(db).suffix}')
...
def gdal_format(file, no_ext_is_gpkg=False, no_ext_is_nc=False):
    ...
    raise MinorConvertException(f'Error: GRID format not supported by COASTALME: {TuflowPath(db).suffix}')
