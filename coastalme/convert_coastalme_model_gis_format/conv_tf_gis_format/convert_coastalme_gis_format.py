...
def main():
    """
    Tool to convert model to a specified COASTALME supported vector and raster format.
    ...
    optional inputs:
        ...
        -write-empties [/rel-path/from/root] - writes COASTALME empty files in the specified GIS format.
    ...
    # create any empty folders within coastalme directory structure
    try:
