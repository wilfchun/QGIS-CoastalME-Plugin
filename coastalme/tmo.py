...
class TMO:
    """
    Class for handling .tmo outputs from COASTALME.
...
class TMO_Header:
    ...
    def _read_block_1(self, version, result_type, pad_size, data_size, data_type, is_regular_time_interval,
                        domain_count, time_count, min_max_flag, minor_version, coastalme_version, *args):
        ...
        if self.version >= 3:
            ...
            self.coastalme_version = coastalme_version
        else:
            self.minor_version = 0
            self.coastalme_version = -1
