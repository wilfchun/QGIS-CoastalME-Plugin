...
class TF_Settings():
	...
	def Load(self):
		...
		try:
			...
			self.global_settings.tf_exe = self.settings.value("COASTALME/exe", "Undefined")
		...
		try:
			...
			self.project_settings.tf_exe = self.project.readEntry("COASTALME","exe","Undefined")[0]
	...
	def Save_Global(self):
		...
		try:
			...
			if self.global_settings.tf_exe:
				self.settings.setValue("COASTALME/exe", self.global_settings.tf_exe)
	...
	def Save_Project(self):
		...
		try:
			...
			if self.project_settings.tf_exe:
				self.project.writeEntry("COASTALME", "exe", self.project_settings.tf_exe)
