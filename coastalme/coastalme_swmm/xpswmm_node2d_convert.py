...
def xpswmm_2d_capture_to_swmm(
    ...
    # Create the COASTALME-SWMM table information
    write_coastalme_version(gpkg_inp_file)
...
if __name__ == "__main__":
    ...
    folder = Path(r'D:\models\COASTALME\test_models\SWMM\SanAntonio\BMT\COASTALME\model\swmm')
