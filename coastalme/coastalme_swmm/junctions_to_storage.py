...
if __name__ == '__main__':
    ...
    junction_filename = r"D:\models\COASTALME\test_models\SWMM\Throsby\HWRS_Huxley\model\swmm\swmm_throsby_114.gpkg"
    gdf_throsby_junctions = gpd.read_file(junction_filename, layer='Nodes--Junctions')

    print(gdf_throsby_junctions.crs)

    bc_throsby_conn_filename = r"D:\models\COASTALME\test_models\SWMM\Throsby\HWRS_Huxley\model\gis\Throsby_102_TBC.gpkg"
