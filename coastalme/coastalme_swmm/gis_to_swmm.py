...
from coastalme.coastalme_swmm.swmm_sections import swmm_section_definitions, primary_node_sections, primary_link_sections, \
    tag_table_type
...
if __name__ == "__main__":
    ...
    files = [
        # Path(
        #    r"D:\models\COASTALME\test_models\SWMM\SanAntonio\Hemisfair-Cesar Chavez Drainage study\BMT\COASTALME\model\swmm\Hemisfair_Ult-Mata_Labor_subcatchments.gpkg"
        # )
        Path(
            r"D:\models\COASTALME\test_models\SWMM\internal\Westwood\converted\rev6.gpkg"
        )
    ]

    # folder = Path(r"D:\models\COASTALME\test_models\SWMM\EPA_examples\Samples_conv")
    # pattern = '*.gpkg'
