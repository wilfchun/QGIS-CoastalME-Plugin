...
try:
    ...
    Polygon = 'Polygon'
from coastalme.coastalme_swmm import swmm_io
from coastalme.coastalme_swmm import swmm_sections
from coastalme.coastalme_swmm.create_swmm_section_gpkg import create_section_gdf
from coastalme.coastalme_swmm.swmm_sections import swmm_section_definitions
...
def swmm_to_gpkg(input_filename, output_filename, crs, tags_to_filter=None, feedback=ScreenProcessingFeedback()):
    ...
    if not Path(output_filename).exists():
        swmm_io.write_coastalme_version(output_filename)
...
if __name__ == "__main__":
    ...
    # input_file = Path(
    #   r"D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\SF\COASTALME\SWMM\SF_complete_outlets_streets_export.inp")
    # input_file = Path(
    #    r'D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\Ruskin\COASTALME\SWMM\Ruskin_002.inp')
    # input_file = Path(
    #       r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\swmm\onechan_trap.inp')
    # files = [
    #    Path(
    #        r"D:\models\COASTALME\test_models\SWMM\GeoPackage_merge_xsections_losses\All 57 culvert types example.inp"
    #    )
    # ]
    ...
    for input_file in files:
        ...
        # projection_filename =
        # Path(r"D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\SF\Projection.prj")
