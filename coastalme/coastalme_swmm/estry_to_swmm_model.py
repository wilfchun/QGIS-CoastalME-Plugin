...
from coastalme.coastalme_swmm.estry_to_swmm import *
...
def ConvertEstryToSwmmFolders(coastalme_folder,
                              check_subfolder,
                              estry_sim,
                              gpkg_check_files,
                              swmm_subfolder,
    ...
    check_folder = coastalme_folder / check_subfolder
    ...
    pit_inlet_dbase_path = coastalme_folder / pit_inlet_dbase_filename

    swmm_out_filename = coastalme_folder / swmm_subfolder / f'{swmm_output_name}.gpkg'

    filename_ta_check = check_folder / f'{estry_sim}_1d_ta_tables_check.csv'

    ext_pathfilename = coastalme_folder / swmm_subfolder / f'{filename_ext_inlet_usage}.gpkg'
...
if __name__ == "__main__":
    ...
    # COASTALME always acts as if on sag
    inlet_placement = ['Auto', 'OnSag'][1]

    coastalme_folder = Path(r"D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME")
    ...
    if sim == 'bankstown':
        coastalme_folder = Path(r"D:\models\COASTALME\test_models\SWMM\Bankstown_C13_rdj\COASTALME")
    ...
    ConvertEstryToSwmmFolders(coastalme_folder, check_subfolder, estry_sim,
