...
if __name__ == "__main__":
    ...
    if model == 'OneChannel':
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\swmm')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\SF\COASTALME\SWMM')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\SF\COASTALME\results')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\OneStreet\COASTALME\swmm')
        swmm_to_gis_filename = 'NotUsedOneStreet.inp'
        gpkg_filename = 'OneStreet_gpkg.gpkg'
        gis_to_swmm_filename = 'OneStreet.inp'
    elif model == 'Mijoulan':
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\PCSWMM_France\BMT\COASTALME\swmm')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\ExampleModels\COASTALME\results\EG15')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\ExampleModels\COASTALME\SWMM')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\Ruskin\COASTALME\SWMM')
        ...
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\SWMM_from_ICM_Models\Ruskin\COASTALME\results')
        swmm_to_gis_filename = 'rs_HPC05_SWMM___001_M5-60_swmm.inp'
        gpkg_filename = 'rs_HPC05_SWMM___001_M5-60_swmm.gpkg'
        gis_to_swmm_filename = 'notused.inp'
        crs = 'EPSG:27700'
    elif model == 'OneD1d':
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\OneD1D_testing\COASTALME\swmm')
        swmm_to_gis_filename = 'onechan_trap.inp'
        gpkg_filename = 'OneD1d.gpkg'
        gis_to_swmm_filename = 'OneD1d.inp'
        crs = 'EPSG:32760'
    elif model == 'Ventura-Arundell1':
        folder = Path(r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Arundell')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Auto_Center')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Brown_Test')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Hall_Canyon')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Harmon')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\SuddenClarke_121218')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM\Ventura_West')
        ...
        folder = Path(
            r'D:\models\COASTALME\test_models\SWMM\internal\Ventura\COASTALME_models\2023\COASTALME\SWMM')
