...
from coastalme.coastalme_swmm.create_swmm_section_gpkg import create_section_gdf, create_section_from_gdf
from coastalme.coastalme_swmm.estry_to_swmm import hw_curve_from_xz, create_curves_from_dfs, pit_inlet_dbase_to_df
from coastalme.coastalme_swmm.gis_to_swmm import gis_to_swmm
from coastalme.coastalme_swmm.swmm_processing_feedback import ScreenProcessingFeedback
from coastalme.coastalme_swmm.swmm_defaults import default_options_table, default_reporting_table
...
def convert_layers(network_layers, node_layers, pit_layers, table_link_layers,
    ...
    if not has_gpd:
        message = ('This tool requires geopandas: to install please follow instructions on the following webpage: '
                   'https://wiki.coastalme.com/QGIS_Intallation_with_OSGeo4W')
    ...
    if gdf_all_nwk_L is not None:
        ...
        if len(gdf_nwk_weirs) > 0:
            ...
            weir_coeff_mapping = {
                ...
                'WB': 0.577,
                'WC': 0.508,
                'WD': 0.577,  # COASTALME User defined
                'WR': 0.62,
                'WT': 0.63,
                'WV': 0.577,  # COASTALME recalculated
                'WW': 0.542,
            }
    ...
    if gdf_all_nwk_L is not None:
        ...
        # Start with WSE at ground (0.0 depth) will be modified when run inside COASTALME
    ...
    if gdf_junction_data is not None:
        ...
        # W types weirs - represent as a curb with similar perimeter to width (used as weir length in COASTALME)
...
if __name__ == "__main__":
    ...
    if simulation == 'Bankstown':
        gis_folder = Path(r'D:\models\COASTALME\test_models\SWMM\Bankstown_C13_rdj\COASTALME\model\gis')
        nwk_layers = [
        ...
        pit_inlet_database = \
            r"D:\models\COASTALME\test_models\SWMM\Bankstown_C13_rdj\COASTALME\pit_dbase\BIV_pit_dbase_001B.csv"
        r"D:\models\COASTALME\test_models\SWMM\Bankstown_C13_rdj\COASTALME\pit_dbase\BIV_pit_dbase_001B.csv"
        output_filename = r'D:\models\COASTALME\test_models\SWMM\Bankstown_C13_rdj\COASTALME\model\SWMM\test_export_layers'
        ...
        gis_folder = Path(r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\gis')
        nwk_layers = [
        ...
        output_filename = r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\SWMM\test_export_base'
        external_gpkg_filename = f'{output_filename}_ext'
        output_filename = output_filename + '.gpkg'
        external_gpkg_filename = external_gpkg_filename + '.gpkg'
        ...
        output_filename = r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\SWMM\test_export_pump'
        external_gpkg_filename = f'{output_filename}_ext'
        output_filename = output_filename + '.gpkg'
        external_gpkg_filename = external_gpkg_filename + '.gpkg'
        ...
        output_filename = r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\SWMM\test_export_weir'
        external_gpkg_filename = f'{output_filename}_ext'
        output_filename = output_filename + '.gpkg'
        external_gpkg_filename = external_gpkg_filename + '.gpkg'
        ...
        output_filename = r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\SWMM\test_export_sluicegate'
        external_gpkg_filename = f'{output_filename}_ext'
        output_filename = output_filename + '.gpkg'
        external_gpkg_filename = external_gpkg_filename + '.gpkg'
        ...
        output_filename = r'D:\models\COASTALME\test_models\SWMM\OneChannel\COASTALME\model\SWMM\test_export_qchan'
        external_gpkg_filename = f'{output_filename}_ext'
        output_filename = output_filename + '.gpkg'
        external_gpkg_filename = external_gpkg_filename + '.gpkg'
