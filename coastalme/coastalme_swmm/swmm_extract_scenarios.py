...
from coastalme.coastalme_swmm.gis_list_layers import get_gis_layers
from coastalme.coastalme_swmm.gis_to_swmm import gis_to_swmm
from coastalme.coastalme_swmm.swmm_io import write_coastalme_version
from coastalme.coastalme_swmm.swmm_processing_feedback import ScreenProcessingFeedback
from coastalme.coastalme_swmm.swmm_sections import primary_node_sections, primary_link_sections
...
def extract_scenarios(gpkg_filenames, scenario_names, output_folder, output_prefix,
    ...
    for scenario, output_filename in zip(scenario_names, output_filenames):
        ...
        if output_filename.exists():
            ...
            write_coastalme_version(output_filename)
        else:
    ...
    feedback.pushInfo('\n\nCOASTALME-SWMM Control File Lines:\n')
...
if __name__ == '__main__':
    gpkg_filenames = [
        r"D:\models\COASTALME\test_models\SWMM\WoodardCurran\bmt_2024_07_26\COASTALME\model\swmm\to1b_001.gpkg",
        r"D:\models\COASTALME\test_models\SWMM\WoodardCurran\bmt_2024_07_26\scenario_Alt01_OU\to1b_001.gpkg",
        r"D:\models\COASTALME\test_models\SWMM\WoodardCurran\bmt_2024_07_26\scenario_Alt02_OU_NT\to1b_001.gpkg",
        r"D:\models\COASTALME\test_models\SWMM\WoodardCurran\bmt_2024_07_26\scenario_Alt03_All\to1b_001.gpkg",
    ]
    scenario_names = [
        'Base',
        'Alt01_OU',
    ...
    output_folder = r'D:\models\COASTALME\test_models\SWMM\WoodardCurran\bmt_2024_07_26\scenarios_out\\'
    output_prefix = 'TO1B'
