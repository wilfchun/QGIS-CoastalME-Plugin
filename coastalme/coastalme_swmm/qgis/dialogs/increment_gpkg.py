...
from coastalme.forms.SWMM_increment_gpkg import Ui_Increment_gpkg
from coastalme.utils import coastalme_plugin
from coastalme.coastalmeqgis_library import coastalmeqgis_increment_fname
from coastalme.toc.toc import coastalmeqgis_get_all_layers_for_datasource, coastalmeqgis_get_geopackage_from_layer
...
class Increment_gpkg(QDialog, Ui_Increment_gpkg):
    ...
    def __init__(self, parent: QDialog, gpkg_filename: str) -> None:
        ...
        incremented_filename = coastalmeqgis_increment_fname(gpkg_filename)
    ...
    def browse(self):
        ...
        file = QFileDialog.getSaveFileName(self,
                                           'COASTALME-SWMM GeoPackage Filename',
...
def run_increment_dlg(gpkg_filename: str, layer: QgsMapLayer) -> None:
    ...
    if dlg.exec():
        ...
        if dlg.unload_orig_layers():
            layers_to_unload = coastalmeqgis_get_all_layers_for_datasource(
                coastalmeqgis_get_geopackage_from_layer(layer)
            )
