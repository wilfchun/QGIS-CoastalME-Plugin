...
import numpy as np
from .COASTALME_results import ResData, Timeseries, NodeInfo, ChanInfo
from .COASTALME_XS import XS, XS_Data
try:
...
class CmeFloodModellerDataProvider(ResData):
    ...
    def Load(self, fname):
        ...
        if ext == '.zzn':
            ...
            csv_version = CmeFloodModellerDataProvider.fm_find_csv_version(fname)
