...
class CmeParticlesDataProviderError(BaseException):
    pass

class CmeParticlesDataProvider:
    def __init__(self):
        self.filename = None
        self.nc = None
    ...
    def load_file(self, filename, defaultRefTime=None):
        ...
        except (KeyError, CmeParticlesDataProviderError) as e:
    ...
    def _build_time_string(self, override_reference_time=None):
        ...
        if len(time_tokens) != 2:
            raise CmeParticlesDataProviderError("Invalid time long_name")
