...
from .coastalmeqgis_library import browse
...
class CmeViewTable(QTableWidget):
...
class MapExportTable(CmeViewTable):
    
    def __init__(self, parent=None):
        CmeViewTable.__init__(self, parent)
...
class PlotItemsTable(CmeViewTable):
...
class GraphicItemsTable(CmeViewTable):
...
class ImageItemsTable(CmeViewTable):
...
class PlotManagerTable(CmeViewTable):
