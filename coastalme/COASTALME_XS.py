...
import numpy as np
# from .coastalmeqgis_library import interpolate
version = '2018-04-AA'
...
class XS():
	...
	def getResults(self, nodeList, channelList, results, selXs):
		"""
		Loads coastalme results for cross sections.

		:param idList: (list) result nodes
		:param results: (list) of COASTALME_results objects
	...
	def loadIntoMemory(self, xsLayer):
		...
		:param xsLayer: QgisVectorLayer of COASTALME cross sections
