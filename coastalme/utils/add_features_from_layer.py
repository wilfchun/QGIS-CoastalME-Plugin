...
from coastalme.forms.ui_replace_features import Ui_dlg_features_from_layer
...
class DlgAddFeaturesFromLayer(QDialog, Ui_dlg_features_from_layer):
    ...
    def accept(self):
        ...
        source_layer = coastalmeqgis_find_layer(source_layer_id, search_type='layerid')
        if source_layer is not None:
            QApplication.setOverrideCursor(QT_CURSOR_WAIT)

            self.dest_layer.startEditing()
            self.dest_layer.beginEditCommand('COASTALME Replace Features')
